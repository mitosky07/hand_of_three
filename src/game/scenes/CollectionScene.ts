...
export class CollectionScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(72, 105, "UPGRADES AVAILABLE DURING RUNS", pixelText(9, "#8fd0c9")).setOrigin(0, .5);
    ...
    (["rock", "paper", "scissors"] as ElementType[]).forEach((element, index) => {
      ...
      this.add.text(565, y + 16, `LEVEL BONUS +${run.upgrades[element]}`, pixelText(9, "#c2cbd0")).setOrigin(0, .5);
    ...
    this.add.text(520, 515, relicText, { ...pixelText(10, run.relics.length ? "#e0ad4f" : "#82949b"), align: "left", lineSpacing: 12 }).setOrigin(0, 0);
  }
}
