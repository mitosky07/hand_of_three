...
export class SettingsScene extends Phaser.Scene {
  ...
  create() {
    ...
    const time = this.add.text(118, 485, "", { ...pixelText(9, "#c7b99b"), align: "left" }).setOrigin(0, 0);
    const render = () => {
    ...
    new GameButton(this, 930, 340, "Toggle motion", () => { settings.reducedMotion = !settings.reducedMotion; saveSettings(settings); render(); }, 300, "purple");
    new GameButton(this, 930, 425, "Export CSV", () => {
    ...
    new GameButton(this, 930, 555, "Back", () => this.scene.start("MainMenuScene"), 300);
  }
}
